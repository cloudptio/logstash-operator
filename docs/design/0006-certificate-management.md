...
Option C is the chosen one here. For more details on the actual workflow, see the [cert-initializer README](https://github.com/cloudptio/logstash-operator/blob/master/operators/cmd/cert-initializer/README.md).
...
* [cert-initializer README](https://github.com/cloudptio/logstash-operator/blob/master/operators/cmd/cert-initializer/README.md) describing interactions between the operator and the cert-initializer init container.
* [coordination with Kibana](https://github.com/cloudptio/logstash-operator/issues/118)
