...
var defaultLogstash = v1beta1.Logstash{
...
func TestReconcileConfigSecret(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				kb: defaultLogstash,
				initialObjects: []runtime.Object{&v1beta1.Logstash{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "test",
						Namespace: "test-ns",
					},
				...
				initialObjects: []runtime.Object{
					&corev1.Secret{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "test-kb-config",
							Namespace: "test-ns",
							Labels:    map[string]string{label.LogstashNameLabelName: defaultLogstash.Name},
						},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			labelSelector := client.MatchingLabels(map[string]string{label.LogstashNameLabelName: tt.args.kb.Name})
