...
If you find an issue, check first our [list of issues](https://github.com/cloudptio/logstash-operator/issues). If your problem has not been reported yet, open a new issue, add a detailed description on how to reproduce the problem and complete it with any additional information that might help solving the issue.
